        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand " href="index.html"><img  src="images/logo1.png" class="logo " style="width: 200px;height: 109px" alt="" ></a>
                </div>
